...
class UpdateTask extends Component{
    ...
    updateTodo = () => {
        ...
        if(this.state.title && this.state.description && this.state.expires_on && this.state.created_by && this.state.expires_at)
        {
...
const mapStateToProps = (state) => {
    // console.log("User reducer ka data jo ki Upate hone wale me aa rha h " + JSON.stringify(state.userReducer));
    // console.log("Personal todos reducer ka data jo ki Upate hone wale me aa rha h " + JSON.stringify(state.personalTodosReducer));
    console.log("updateTodoId reducer ka data jo ki Upate hone wale me aa rha h " + JSON.stringify(state.updateTodoIdReducer));
    return {
