...
import '../css/UserSidemenu.css';  // WE WILL USER THE SAME CSSWHICH WE ARE USING FOR THE USER SIDE MENU 
...
export default connect(null, mapDispatchToProps)(GroupSidemenu);